...
`main.tpl` И в подключённых шаблонах.
  ...
  - [collections-alllist] text [/collections-alllist] Выводит заключённый в теге текст на странице всех подборок. :new:
  - {c-title} Выводит название подборки \ либо meta-title.
  - {c-descr} Выводит описание подборки \ либо meta-description.
