...
:exclamation:На лицензионных скриптах могут быть проблемы.

`То кнопки загрузки постера нету то подборки не выводит.`
> Напишите в телегу кто может дать доступ к лицензионному движку для поиска и устранения не выявленных ранее мной проблем.
...
---
 ...
 - Быстрый поиск группы новостей по заголовку, тегам или дополнительным полям
---
