...
:exclamation::exclamation::exclamation: Я не даю гарантий на правильную работу при использовании посторонних модулей, если у Вас не получается что-то или не работает, это ваша проблема, а не моя :exclamation::exclamation::exclamation:
...
:exclamation::exclamation::exclamation: Кто считает это говнокодом - то вот ответ. Я модуль не писал, это всё производные частей движка, закладки подборок, поиск, вывод, и всё остальное это простейший ctrl-c\ctrl-v частей CMS. Я собрал модуль для ознакомления буквально из говна и палок не прибегая, как из подручных вещей можно сделать совсем другой функционал. Оскорбляя этот код, Вы оскорбляете разработчика системы. Не нравиться, проходите мимо и не скулите.:exclamation::exclamation::exclamation:
