# Collections-DLE (Обновлено от  [07.08.2019](https://github.com/TeraMoune/Collections-DLE/wiki#07082019))
...
`main.tpl` И в подключённых шаблонах.
  ...
  - {collections ids-news id="N"} - Выводит список ID новостей принадлежащих подборке, где N id подборки. (Для использования в кастомном выводе новостей) :new:
