...
:exclamation:У кого проблемы с кнопкой загрузки постера, у Вас проблема с Javascript не с самим плагином, выдирайте код для загрузчика откуда нибудь из другого места, например в `inc/xfields.php` В принципе от туда и взята функция js.
