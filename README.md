...
> Напишите в телегу кто может дать доступ к лицензионному движку для поиска и устранения не выявленных ранее мной проблем. (Если конечно проблема есть и нужно исправить)
